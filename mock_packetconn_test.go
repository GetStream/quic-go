...
//
//	mockgen -typed -package quic -self_package github.com/GetStream/quic-go -self_package github.com/GetStream/quic-go -destination mock_packetconn_test.go net PacketConn
//
